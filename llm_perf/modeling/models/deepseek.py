...
Includes:
- ShardedMoEBlock: Transformer block with Attention + MoE + Norms
- DeepSeekModel: Complete DeepSeek model with MLA and MoE
"""
...
class DeepSeekModel(ShardedModule):
    ...
    def __init__(
        ...
        from .llama import ShardedTransformerBlock
