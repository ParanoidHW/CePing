"""Pydantic-based Evaluation engine for workload analysis.

This engine:
1. Receives EvaluationRequest from API/CLI
2. Validates the request (Pydantic auto-validates)
...
from .schema_pydantic import HardwareSchema, StrategySchema
